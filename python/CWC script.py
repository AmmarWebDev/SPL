...
df = pd.read_csv("../database/SPL CWC records.csv", dtype={'User ID': str})
...
# Output: Top Scorers
print("# SPL Club World Cup Top 10 Scorers Till Now:")
...
# Output: Top Assists
print("\n# SPL Club World Cup Top 10 Assistors Till Now:")
